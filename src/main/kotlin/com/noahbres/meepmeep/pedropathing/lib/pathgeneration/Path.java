...
public class Path {
    ...
    /**
     * This returns if the robot is at the end of the path, according to the displacement traveled
     *
     * @param displacementTraveled the displacement traveled by the robot
     * @return returns if at end
     */
    public boolean isAtParametricEnd(double displacementTraveled) {
        double pathLength = length();
        return displacementTraveled >= pathLength;
    }
