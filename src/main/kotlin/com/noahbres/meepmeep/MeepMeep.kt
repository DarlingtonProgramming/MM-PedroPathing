...
open class MeepMeep @JvmOverloads constructor(private val windowSize: Int, fps: Int = 60) {
    ...
    private val progressSliderMasterPanel: PathProgressSliderMaster by lazy {
        PathProgressSliderMaster(
            this,
...
//        windowFrame.contentPane.add(middleButtonPanel)
    ...
    fun start(): MeepMeep {
        ...
        entityList.forEach {
            ...
            if (it is PedroPathingBotEntity) it.start()
        }
    ...
    fun addEntity(entity: Entity): MeepMeep {
        ...
        if (entity is PedroPathingBotEntity)
            progressSliderMasterPanel.addPedroPathingBot(entity)
    ...
    fun removeEntity(entity: Entity): MeepMeep {
        ...
        if (entity is PedroPathingBotEntity)
            progressSliderMasterPanel.removePedroPathingBot(entity)
